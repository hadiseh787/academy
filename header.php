...
<head>
    ...
    <meta name="author" content="Bagherian"/>
    <meta name="keywords" content="didarsalesacademy"/>
        ...
        <div class="main-menu">
            <div class="left">
                <a class="logo" href="<?php echo home_url(); ?>">
                    <div class="img">
                        <img src="<?php echo SALES_ACADEMY; ?>/assets/img/logo.svg" alt="">
                    </div>
                </a>
            </div>
                    ...
                    <div id="menuToggle" class="accordianNav">
                        ...
                        <ul id="menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="https://didarsalesdemy.com/courses/Sales-Representative/">کارشناس
                                            فروش</a></li>
