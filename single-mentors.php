                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="img text-center">
                            ...
                            <?php else: ?>
                                <img src="<?php echo SALES_ACADEMY; ?>/assets/img/avatar2.png" alt="">
                            <?php endif; ?>
                        </div>
                        <a class="view-all" href="<?php echo home_url(); ?>/mentors">
                            مشاهده همه منتورها <img src="<?php echo SALES_ACADEMY; ?>/assets/img/arrow-left.svg"
                                                   alt="">
                        </a>
                        <div class="social">
